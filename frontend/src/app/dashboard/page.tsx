  ...
  const handleGenerateBlog = async () => {
    ...
    try {
      ...
      const blogData: Omit<Blog, 'id' | 'createdAt' | 'updatedAt'> = {
        ...
        generationSettings: {
          usePerplexity: false, // This could be a user setting in the future
          articleFraming: contentType, // Using content type as article framing for now
        }
      };
      ...
      <div className="flex h-screen">
        ...
        <aside className="w-64 bg-white shadow-md flex flex-col">
          ...
          <div className="p-4 border-b">
            <h1 className="text-xl font-bold text-gray-900">EnhanceMySEO</h1>
          </div>
          ...
          {/* User Profile */}
          <div className="p-4 border-t mt-auto relative" ref={userMenuRef}>
            <button
            ...
            {/* Dropdown Menu */}
            {showUserMenu && (
              <div className="absolute left-1/2 transform -translate-x-1/2 w-56 mt-2 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50 bottom-full mb-2">
                <div className="py-1" role="menu">
                  <button
                    onClick={handleLogout}
                    className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 flex items-center justify-center"
                    role="menuitem"
                  >
                    <svg
