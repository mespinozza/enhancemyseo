...
def main(num_keywords=None):
    ...
    with open(output_file, "w", newline="", encoding="utf-8") as csvfile:
        ...
        for i, keyword in enumerate(keywords):
            if num_keywords is not None and i >= num_keywords:
                break
...
if __name__ == "__main__":
    num_keywords = int(sys.argv[1]) if len(sys.argv) > 1 else None
    main(num_keywords)